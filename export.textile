...
We won't cover this deeply, but want to give the advise to have a look at "Photoshop's scripting features":http://www.adobe.com/devnet/photoshop/scripting.html. With a little effort you can create an automatic process, that switches on/off layers and saves the texture variants you need automatically. Once setup, this reduces the potential for mistakes alot (especially if you have many different variants) and allows you to get a coffee, while the script is running.
...
This is at the moment the only way to install additional skins. The following only covers export specially for the IFM-2009 mod.  "For a more general tutorial look here.":export_common.html
...
<pre>
rFactor2 Data/UserData/<UserName>/Settings/IFM2009
</pre>
